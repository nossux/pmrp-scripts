    ...
    if not carry.InProgress then
        ...
        if closestPlayer then
            ...
            if targetSrc ~= -1 then
                ...
                TriggerServerEvent("nos_player:carry:sync", targetSrc)
        ...
        TriggerServerEvent("nos_player:carry:stop", carry.targetSrc)
        carry.targetSrc = 0
    end
end, false)

RegisterNetEvent("nos_player:carry:syncTarget")
AddEventHandler("nos_player:carry:syncTarget", function(targetSrc)
...
RegisterNetEvent("nos_player:carry:cl_stop")
AddEventHandler("nos_player:carry:cl_stop", function()
    carry.InProgress = false
    ClearPedSecondaryTask(PlayerPedId())
    DetachEntity(PlayerPedId(), true, false)
end)
